...
import static com.lld.parkinglot.model.parking.ParkingSpotType.*;
...
public class ParkingFloor {
    ...
    public boolean isFloorFull() {
        for (Deque<ParkingSpot> spots : parkingSpots.values()) {
            if (!spots.isEmpty()) {
                return false; // At least one type of parking spot has available space
            }
        }
        return true; // All types of parking spots are full
    }
